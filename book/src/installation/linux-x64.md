...
wget https://github.com/winnyboy5/mediagit-core/releases/download/v0.2.1-beta.2/mediagit_0.2.1-beta.2_amd64.deb

# Install
sudo dpkg -i mediagit_0.2.1-beta.2_amd64.deb
...
```bash
# Download latest release
wget https://github.com/winnyboy5/mediagit-core/releases/download/v0.2.1-beta.2/mediagit-0.2.1-beta.2-1.x86_64.rpm

# Install
sudo rpm -i mediagit-0.2.1-beta.2-1.x86_64.rpm
```
...
```bash
# Download archive
wget https://github.com/winnyboy5/mediagit-core/releases/download/v0.2.1-beta.2/mediagit-0.2.1-beta.2-x86_64-linux.tar.gz

# Verify checksum
wget https://github.com/winnyboy5/mediagit-core/releases/download/v0.2.1-beta.2/mediagit-0.2.1-beta.2-x86_64-linux.tar.gz.sha256
sha256sum -c mediagit-0.2.1-beta.2-x86_64-linux.tar.gz.sha256

# Extract (contains mediagit + mediagit-server)
tar -xzf mediagit-0.2.1-beta.2-x86_64-linux.tar.gz
