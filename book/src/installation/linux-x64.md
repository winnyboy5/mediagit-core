...
wget https://github.com/winnyboy5/mediagit-core/releases/download/v0.2.3-beta.1/mediagit_0.2.3-beta.1_amd64.deb

# Install
sudo dpkg -i mediagit_0.2.3-beta.1_amd64.deb
...
```bash
# Download latest release
wget https://github.com/winnyboy5/mediagit-core/releases/download/v0.2.3-beta.1/mediagit-0.2.3-beta.1-1.x86_64.rpm

# Install
sudo rpm -i mediagit-0.2.3-beta.1-1.x86_64.rpm
```
...
```bash
# Download archive
wget https://github.com/winnyboy5/mediagit-core/releases/download/v0.2.3-beta.1/mediagit-0.2.3-beta.1-x86_64-linux.tar.gz

# Verify checksum
wget https://github.com/winnyboy5/mediagit-core/releases/download/v0.2.3-beta.1/mediagit-0.2.3-beta.1-x86_64-linux.tar.gz.sha256
sha256sum -c mediagit-0.2.3-beta.1-x86_64-linux.tar.gz.sha256

# Extract (contains mediagit + mediagit-server)
tar -xzf mediagit-0.2.3-beta.1-x86_64-linux.tar.gz
