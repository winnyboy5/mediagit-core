...
# Install MediaGit
wget https://github.com/winnyboy5/mediagit-core/releases/download/v0.3.0-rc.2/mediagit-0.3.0-rc.2-aarch64-linux.tar.gz
tar -xzf mediagit-0.3.0-rc.2-aarch64-linux.tar.gz
