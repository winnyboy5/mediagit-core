...
```bash
curl -fsSL https://github.com/winnyboy5/mediagit-core/releases/download/v0.2.1/mediagit-0.2.1-aarch64-macos.tar.gz \
  | tar xz -C /usr/local/bin
```
...
# Should output: mediagit-core 0.2.1
...
### Docker
```bash
docker rmi ghcr.io/winnyboy5/mediagit-core:0.2.1
```
