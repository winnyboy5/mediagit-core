...
sed -i 's/^version = ".*"/version = "0.2.1-beta.1"/' Cargo.toml
...
git commit -m "chore: release v0.2.1-beta.1"
...
git tag -a v0.2.1-beta.1-alpha.1 -m "Pre-release v0.2.1-beta.1-alpha.1"
git push origin v0.2.1-beta.1-alpha.1
```
...
git checkout -b hotfix/v0.2.2 v0.2.1-beta.1
