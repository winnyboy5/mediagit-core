...
sed -i 's/^version = ".*"/version = "0.3.0-rc.2"/' Cargo.toml
...
git commit -m "chore: release v0.3.0-rc.2"
...
```bash
# Stable release
git tag -a v0.3.0-rc.2 -m "Release v0.3.0-rc.2"
git push origin v0.3.0-rc.2

# Pre-release (alpha/beta/rc)
git tag -a v0.3.0-rc.2 -m "Pre-release v0.3.0-rc.2"
git push origin v0.3.0-rc.2
```
...
git checkout -b hotfix/v0.3.0 v0.3.0-rc.2
