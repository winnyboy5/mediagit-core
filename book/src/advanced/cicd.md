  ...
  verify-assets:
    ...
    steps:
      ...
      - name: Install MediaGit
        run: |
          curl -fsSL https://github.com/winnyboy5/mediagit-core/releases/latest/download/mediagit-0.2.1-beta.2-x86_64-linux.tar.gz \
...
- name: Cache MediaGit binary
  ...
  with:
    ...
    key: mediagit-${{ runner.os }}-0.2.1-beta.2
```
