...
```bash
# Update version to 0.2.1 (example)
...
- [ ] Test Docker image:
  ```bash
  docker run --rm ghcr.io/winnyboy5/mediagit-core:0.2.1 --version
  ```
...
```bash
# Alpha
git tag -a v0.2.1-alpha.1 -m "Release 0.2.1-alpha.1"

# Beta
git tag -a v0.2.1-beta.1 -m "Release 0.2.1-beta.1"

# Release Candidate
git tag -a v0.2.1-rc.1 -m "Release 0.2.1-rc.1"
```
...
1. Create hotfix branch from the release tag:
   ```bash
   git checkout -b hotfix/0.2.1 v0.2.1
   ```
...
4. Submit to Chocolatey Community: `choco push mediagit.0.2.1.nupkg --source https://push.chocolatey.org/`
