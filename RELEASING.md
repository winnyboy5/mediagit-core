...
git tag -a v0.3.0-rc.1 -m "Release version 0.3.0-rc.1"
...
- [ ] Test Docker image:
  ```bash
  docker run --rm ghcr.io/winnyboy5/mediagit-core:0.3.0-rc.1 --version
  ```
...
1. Create hotfix branch from the release tag:
   ```bash
   git checkout -b hotfix/0.3.0 v0.3.0-rc.1
   ```
...
4. Submit to Chocolatey Community: `choco push mediagit.0.3.0-rc.1.nupkg --source https://push.chocolatey.org/`
