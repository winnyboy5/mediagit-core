...
git tag -a v0.3.0-rc.2 -m "Release version 0.3.0-rc.2"
...
- [ ] Test Docker image:
  ```bash
  docker run --rm ghcr.io/winnyboy5/mediagit-core:0.3.0-rc.2 --version
  ```
...
# Release Candidate
git tag -a v0.3.0-rc.2 -m "Release 0.3.0-rc.2"
```
...
1. Create hotfix branch from the release tag:
   ```bash
   git checkout -b hotfix/0.3.0 v0.3.0-rc.2
   ```

2. Make and commit the fix
3. Update version to patch release (0.3.0-rc.2)
...
2. Delete the git tag locally and remotely:
   ```bash
   git tag -d v0.3.0-rc.2
   git push origin :refs/tags/v0.3.0-rc.2
   ```
...
4. Submit to Chocolatey Community: `choco push mediagit.0.3.0-rc.2.nupkg --source https://push.chocolatey.org/`
