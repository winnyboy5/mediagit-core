...
./scripts/bump-version.sh 0.3.0-rc.3   # example
...
git add -A
git commit -m "chore: prepare release 0.3.0-rc.3"
...
git tag -a v0.3.0-rc.3 -m "Release version 0.3.0-rc.3"
...
- [ ] Test Docker image:
  ```bash
  docker run --rm ghcr.io/winnyboy5/mediagit-core:0.3.0-rc.3 --version
  ```
...
# Release Candidate
git tag -a v0.3.0-rc.3 -m "Release 0.3.0-rc.3"
```
...
1. Create hotfix branch from the release tag:
   ```bash
   git checkout -b hotfix/0.3.0 v0.3.0-rc.3
   ```

2. Make and commit the fix
3. Update version to patch release (0.3.0-rc.3)
...
4. Submit to Chocolatey Community: `choco push mediagit.0.3.0-rc.3.nupkg --source https://push.chocolatey.org/`
